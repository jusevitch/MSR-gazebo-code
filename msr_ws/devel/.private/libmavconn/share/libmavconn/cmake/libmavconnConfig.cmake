...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/dasc/Ruilin/MSR-gazebo-code/msr_ws/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/dasc/Ruilin/MSR-gazebo-code/msr_ws/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/dasc/Ruilin/MSR-gazebo-code/msr_ws/install)
...
if(NOT "/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/src/mavros/libmavconn/include;/usr/include;/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/src/mavros/libmavconn/include;/usr/include;/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dasc/Ruilin/MSR-gazebo-code/msr_ws/devel/.private/libmavconn/lib;/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/devel/lib;/opt/ros/kinetic/lib)
