...
if("TRUE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /home/dasc/Ruilin/MSR-gazebo-code/msr_ws/src/mavros/mavros)
  set(mavros_DEVEL_PREFIX /home/dasc/Ruilin/MSR-gazebo-code/msr_ws/devel/.private/mavros)
  set(mavros_INSTALL_PREFIX "")
  set(mavros_PREFIX ${mavros_DEVEL_PREFIX})
else()
  set(mavros_SOURCE_PREFIX "")
  set(mavros_DEVEL_PREFIX "")
  set(mavros_INSTALL_PREFIX /home/dasc/Ruilin/MSR-gazebo-code/msr_ws/install)
...
if(NOT "/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/src/mavros/mavros/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(mavros_INCLUDE_DIRS "")
  set(_include_dirs "/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/src/mavros/mavros/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/src/mavros/mavros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dasc/Ruilin/MSR-gazebo-code/msr_ws/devel/.private/mavros/lib;/home/dasc/Ruilin/MSR-gazebo-code/msr_ws/devel/lib;/opt/ros/kinetic/lib)
