...
% method 2: Cubic Polynomial, nonlinear control
...
% control gains
k2 = 0.9;
k1 = @(t) (vd(t).^2 + wd(t).^2) * 5;
k3 = @(t) (vd(t).^2 + wd(t).^2) * 5;
...
for i = 1:steps-1
   ...
   % error dynamics control inputs (nonlinear control)
   u1 = -k1(t)*e1;
   u2 = -k2*vd(t)*sin(e3)/e3*e2 - k3(t)*e3;
